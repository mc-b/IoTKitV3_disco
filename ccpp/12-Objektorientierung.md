...
Beispiele Objekte:
    ...
    DigitalOut led1( LED1 ); // Instanzieren eines Objektes mit dem Namen led1 anhand der Klasse DigitalOut, als Pin (Daten) wird LED1 übergeben.
    DigitalOut led2( LED2 ); // Gleiche Klasse (DigitalOut), neues Objekt, neuer Name (led2) und andere Daten (LED2)
